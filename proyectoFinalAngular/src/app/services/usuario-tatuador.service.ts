...
export class UsuarioTatuadorService {
  ...
  //Query params es un mapa que construyes donde llamas a esta funcion
  //si esta vacia, no tendra ningun query param. Una misma funcion vale para todos los casos
